...
train_step = tf.train.AdamOptimizer(lr).minimize(cross_entropy) # Possible to use GradientDecentOptimizer, converge slower, less acurate
...
def training_step(i, update_test_data, update_train_data):
    ...
    learningRate = 0.0001+(0.003-0.0001)*math.exp(-1*i/2000)
